            ...
            <form method="POST" action="crear_incidencia.php" id="formulariIncidencia">
                ...
                <div class="mb-3">
                    ...
                    <select name="idDepartament" id="idDepartament" class="form-select">
                        <option value="" disabled selected style="color: gray;">-- Selecciona un departament --</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea placeholder="Escriu com a mínim 20 caràcters" name="descripcio" id="descripcio" class="form-control" rows="4"></textarea>
                </div>
